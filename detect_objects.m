...
% commented from an older version of MATLAB
% n_cores = 2;              %% number of cores to use. Matlab doesn't let you use more that 8 cores on a single machine. decrese it if you have less than 8 cores.
